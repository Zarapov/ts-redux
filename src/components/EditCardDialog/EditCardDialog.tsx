    ...
    return(
        <div>
            ...
            <div className='btn-group'>
                ...
                { 
                    id?
                    <button type='button' className='btn btn-confirm' onClick={e=>editItemCard({id:id,src:image,text:name})}>Сохранить</button>:
                    <button type='button' className='btn btn-confirm' onClick={e=>addItemCard({src:image,text:name})}>Добавить</button>
                }
